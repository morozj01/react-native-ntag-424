...
declare module 'react-native-nfc-manager' {
  ...
  interface MifareClassicHandlerAndroid {
    ...
    mifareClassicIncrementBlock: (block: ArrayLike<number>, data: number) => Promise<void>;
    mifareClassicDecrementBlock: (block: ArrayLike<number>, data: number) => Promise<void>;
